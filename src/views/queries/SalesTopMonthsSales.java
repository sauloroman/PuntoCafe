...
public class SalesTopMonthsSales extends javax.swing.JFrame {

    private final SalesTopMonthsSalesInit style = new SalesTopMonthsSalesInit(this);
    
    public SalesTopMonthsSales() {
        initComponents();
        style.init();
    }
