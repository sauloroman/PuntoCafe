...
public class PurchasesAvgSaleMonth extends javax.swing.JFrame {

    private final PurchasesAvgSaleMonthInit style = new PurchasesAvgSaleMonthInit(this);
    
    public PurchasesAvgSaleMonth() {
        initComponents();
        style.init();
    }
