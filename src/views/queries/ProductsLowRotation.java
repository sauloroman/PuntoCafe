...
public class ProductsLowRotation extends javax.swing.JFrame {

    private final ProductsLowRotationInit style = new ProductsLowRotationInit(this);
    
    public ProductsLowRotation() {
        initComponents();
        style.init();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Productos con baja rotación");
        ...
        quantityCombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "30", "60", "90" }));

        jLabel3.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        jLabel3.setText("En los últimos (*) días");
