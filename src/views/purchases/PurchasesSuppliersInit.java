...
public class PurchasesSuppliersInit {
    ...
    public void init() {
        ...
        buttonGenerator.solidButton(view.btnNewSupplier, NEW_BTN_COLOR, "#ffffff", 11);
        ...
        buttonGenerator.solidButton(view.btnDeactivateSupplier, "#ffe3e3", ViewConstants.textBtn, 11);
        ...
        buttonGenerator.solidButton(view.btnUpdateSupplier, NEW_BTN_COLOR, "#FFFFFF", 11);
